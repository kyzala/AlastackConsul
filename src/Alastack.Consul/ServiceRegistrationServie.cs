...
public class ServiceRegistrationServie : IHostedService
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ServiceRegistrationServie"/>.
    /// </summary>
    /// <param name="options"><see cref="ConsulOptions"/></param>
    /// <exception cref="ArgumentNullException"><see cref="ConsulOptions.Registration"/> can not be null.</exception>
